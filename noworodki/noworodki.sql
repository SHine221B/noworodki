...
--
-- Host: 127.0.0.1
-- Czas generowania: 24 Kwi 2018, 18:05
...
CREATE TABLE `noworodki` (
  ...
  `indentyfikator_matki` int(11) NOT NULL
...
INSERT INTO `noworodki` (`Identyfikator`, `plec`, `imie`, `data_urodzenia`, `waga`, `wzrost`, `indentyfikator_matki`) VALUES
